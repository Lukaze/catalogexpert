/**
 * App Modal Renderer Module
 * Handles rendering content for app detail modals including tabs and content generation
 */
class AppModalRenderer {
    /**
    ...
    renderPreconfiguredEntitlements(entitlementInfo) {
        ...
        Object.entries(entitlementInfo).forEach(([audience, entitlements]) => {
            ...
            entitlements.forEach(entitlement => {
                const stateClass = window.modalManager.getStateClass(entitlement.state);
                const stateIcon = window.modalManager.getStateIcon(entitlement.state);
                html += `
...
// Make AppModalRenderer available globally
window.AppModalRenderer = AppModalRenderer;
window.appModalRenderer = new AppModalRenderer();
